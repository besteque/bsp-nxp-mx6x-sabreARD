 ...
 */
extern int mini_can_preconfigure(minican_config_t const * const _config);
extern int mini_can(int state, void *data);

#endif

#if defined(__QNXNTO__) && defined(__USESRCVERSION)
#include <sys/srcversion.h>
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/startup/boards/imx6x/mini-can/mini_can.h $ $Rev: 790420 $")
#endif
