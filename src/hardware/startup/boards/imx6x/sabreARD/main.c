...
main(int argc, char **argv, char **envv)
{
	...
	if(imx6_quad_dual)
	{
		if(imx6_quad_plus)
		{
			add_typed_string(_CS_MACHINE, "i.MX6 QuadPlus Sabre-ARD Board");
		}
		else
		{
			add_typed_string(_CS_MACHINE, "i.MX6 Quad or Dual Sabre-ARD Board");
		}
	}
	else
	{
		add_typed_string(_CS_MACHINE, "i.MX6 DualLite or Solo Sabre-ARD Board");
	}
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/startup/boards/imx6x/sabreARD/main.c $ $Rev: 805662 $")
#endif
