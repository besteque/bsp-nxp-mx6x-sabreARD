...
int main()
{
	...
	init_aips();  	/* Allow access to the AIPS registers */

	init_clocks();	/* Initialise the system clocks */
...
#include <sys/srcversion.h>
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/ipl/boards/mx6x-sabreARD/main.c $ $Rev: 819397 $")
#endif
