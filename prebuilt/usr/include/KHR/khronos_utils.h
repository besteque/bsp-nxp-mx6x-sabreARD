...
typedef int (KHRONOS_APICALL *__khrGetConfigValueFuncType)(int, const char*, char*, int);
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/lib/khronos/private/KHR/khronos_utils.h $ $Rev: 820938 $")
#endif
